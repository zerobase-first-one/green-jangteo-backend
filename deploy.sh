...
docker run -d \
    ...
    -e FRONTEND_IP_FOR_GREEN_JANGTEO=$FRONTEND_IP_FOR_GREEN_JANGTEO \
    -e FRONTEND_PORT_FOR_GREEN_JANGTEO=$FRONTEND_PORT_FOR_GREEN_JANGTEO \
    -e FRONTEND_LOCAL_IP_FOR_GREEN_JANGTEO=$FRONTEND_LOCAL_IP_FOR_GREEN_JANGTEO \
    -e FRONTEND_LOCAL_PORT_FOR_GREEN_JANGTEO=$FRONTEND_LOCAL_PORT_FOR_GREEN_JANGTEO \
