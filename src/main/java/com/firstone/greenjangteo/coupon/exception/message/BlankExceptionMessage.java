...
public class BlankExceptionMessage {
    ...
    public static final String ISSUE_QUANTITY_NO_VALUE_EXCEPTION = "발행 매수는 필수값입니다.";
    public static final String EXPIRATION_PERIOD_NO_VALUE_EXCEPTION = "쿠폰 유효기간은 필수값입니다.";
}
